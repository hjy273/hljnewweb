...
public class CableSegment{
    ...
    private java.math.BigDecimal grosslength;//皮长
    ...
    private java.math.BigDecimal reservedlength;//预留长度
    ...
    public void setGrosslength( java.math.BigDecimal grosslength ){
    ...
    public void setReservedlength( java.math.BigDecimal reservedlength ){
    ...
    public java.math.BigDecimal getGrosslength(){
        return grosslength;
    }
    ...
    public java.math.BigDecimal getReservedlength(){
