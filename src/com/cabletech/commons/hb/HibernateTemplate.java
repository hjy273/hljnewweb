...
public class HibernateTemplate{
     ...
     */
    public HibernateTemplate( HibernateSession sessionFactory ){
     ...
     * Hibernate Sessions.
     */
    public void setSessionFactory( HibernateSession sessionFactory ){
     ...
     */
    public Object execute( HibernateCallback action ) throws Exception{
        /*
        ...
        try{
            sessionFactory.currentTransaction();
     ...
     */
    public Object load( final Class entityClass, final Serializable id ) throws Exception{
     ...
     * @throws DataAccessException in case of Hibernate errors
     * @see org.hibernate.Session#delete(String)
     */
    public void deleteAll( final List entities ) throws Exception{
        execute( new HibernateCallback(){
            public Object doInHibernate( Session session ) throws HibernateException{
     ...
     * @throws DataAccessException in case of Hibernate errors
     */
    public List executeFind( HibernateCallback action ) throws Exception{
     ...
     * @throws DataAccessException in case of Hibernate errors
     * @see org.hibernate.Session#find(String)
     ...
     * @see org.hibernate.Session#createQuery
     */
    public List find( final String queryString, final Object value ) throws Exception{
        return executeFind( new HibernateCallback(){
            public Object doInHibernate( Session session ) throws HibernateException{
                Query queryObject = createQuery( session, queryString );
     ...
     * @see org.hibernate.Session#createQuery
     */
    public List find( final String queryString, final Object value, final Type type ) throws Exception{
        return executeFind( new HibernateCallback(){
            public Object doInHibernate( Session session ) throws HibernateException{
                Query queryObject = createQuery( session, queryString );
     ...
     * @see org.hibernate.Session#createQuery
     */
    public List find( final String queryString, final Object[] values, final Type[] types ) throws Exception{
     ...
     */
    public List findByNamedQuery( final String queryName ) throws Exception{
        return executeFind( new HibernateCallback(){
            public Object doInHibernate( Session session ) throws HibernateException{
     ...
     * @see org.hibernate.Session#getNamedQuery(String)
     */
    public List findByNamedQuery( final String queryName, final Object value ) throws Exception{
        return executeFind( new HibernateCallback(){
            public Object doInHibernate( Session session ) throws HibernateException{
                Query queryObject = getNamedQuery( session, queryName );
                queryObject.setParameter( 0, value );
     ...
     * @see org.hibernate.Session#getNamedQuery(String)
     */
    public List findByNamedQuery( final String queryName, final Object value, final Type type ) throws Exception{
        return executeFind( new HibernateCallback(){
            public Object doInHibernate( Session session ) throws HibernateException{
                Query queryObject = getNamedQuery( session, queryName );
                queryObject.setParameter( 0, value, type );
     ...
     * @see org.hibernate.Session#getNamedQuery(String)
     */
    public List findByNamedQuery( final String queryName, final Object[] values, final Type[] types ) throws Exception{
        if( values.length != types.length ){
            throw new IllegalArgumentException( "Length of values array must match length of types array" );
        }
        return executeFind( new HibernateCallback(){
