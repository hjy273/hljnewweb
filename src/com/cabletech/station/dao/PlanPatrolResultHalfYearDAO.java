 ...
 *
 */
public class PlanPatrolResultHalfYearDAO extends BaseDAO {
     ...
     *            String 查询条件
     * @return List 返回波分半年计划的列表信息
     * @throws Exception
     */
    public List queryByCondition(String sqlCondition) throws Exception {
        try {
            String sql = "select tid from plan_patrol_result_half_year where 1=1 " + sqlCondition;
            query = new QueryUtil();
