...
public class TroubleGuideYear extends BaseDomainObject {
	...
	private String year;
	private Double maintenanceLength=0.0;//维护公里数
	private Double interdictionNormTimes=0.0;//千公里阻断次数基准值
	private Double interdictionDareTimes=0.0;//千公里阻断次数挑战值
	private int troubleTimes;//故障次数
	private Double interdictionNormTime=0.0;//千公里阻断时长基准值
	private Double interdictionDareTime=0.0;//千公里阻断时长挑战值
	private Double interdictionTime=0.0;//阻断时长
	//private Double troubleInterdictionTime;//千公里阻断历时
//	private Double troubleInterdictionTimes;//千公里阻断次数
	private Double rtrTimeNormValue=0.0;//光缆抢修平均时长指标基准值
	private Double rtrTimeDareValue=0.0;//光缆抢修平均时长指标挑战值
	private Double rtrTimeFinishValue=0.0;//光缆抢修平均时长指标完成值
