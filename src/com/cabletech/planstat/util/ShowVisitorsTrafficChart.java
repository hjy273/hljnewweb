...
public class ShowVisitorsTrafficChart  extends HttpServlet{
	 private Logger logger = Logger.getLogger("ShowVisitorsTrafficChart") ;
	 public void service( ServletRequest req, ServletResponse res ) throws
     ServletException, IOException{
		 List list = (List)((HttpServletRequest)req).getSession().getAttribute("visitorsTrafficList");	 
		 ...
		 if (list.size()==0){
			 ...
			 //title =  regionname + logPathBean.getStartDate() +"至" + logPathBean.getEndDate() + "各模块访问情况显示图"; 
			 title =  "各模块访问情况显示图"; 
