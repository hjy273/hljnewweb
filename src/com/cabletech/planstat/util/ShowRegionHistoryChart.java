...
public class ShowRegionHistoryChart  extends HttpServlet{
	 private Logger logger = Logger.getLogger("ShowRegionHistoryChart") ;
	 ...
	 private static DefaultCategoryDataset getDataSet(List list){
		 ...
		 if (!list.isEmpty() && list.size()>0){
		    	for ( int i = 0;i<list.size();i++){  
		    		mydata.addValue(Integer.parseInt(((BasicDynaBean)list.get(i)).get("patrolnum").toString()), "巡检", (String)((BasicDynaBean)list.get(i)).get("regionname"));
		    		mydata.addValue(Integer.parseInt(((BasicDynaBean)list.get(i)).get("watchnum").toString()), "盯防", (String)((BasicDynaBean)list.get(i)).get("regionname"));
		    		mydata.addValue(Integer.parseInt(((BasicDynaBean)list.get(i)).get("collectnum").toString()), "采集", (String)((BasicDynaBean)list.get(i)).get("regionname"));
		    		mydata.addValue(Integer.parseInt(((BasicDynaBean)list.get(i)).get("troublenum").toString()), "隐患", (String)((BasicDynaBean)list.get(i)).get("regionname"));
		    		mydata.addValue(Integer.parseInt(((BasicDynaBean)list.get(i)).get("othernum").toString()), "其它", (String)((BasicDynaBean)list.get(i)).get("regionname"));
		    	}
		 }
