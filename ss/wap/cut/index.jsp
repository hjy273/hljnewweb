		...
		<table width="100%" style="text-align: center;">
			<tr>
				<td height="60px" valign="bottom" width="33%">
					<a href="${ctx}/wap/cutAction.do?method=queryCutNum&&env=wap"><img
							src="${ctx}/images/wap/dclgz.png" border="0" /> <br />割接处理情况</a>
				</td>
				<td height="60px" valign="bottom" width="33%">
					<a href="${ctx}/wap/cutAction.do?method=queryCut&&env=wap"><img
							src="${ctx}/images/wap/dclgj.png" border="0" /> <br />待处理割接</a>
				</td>
