...
<html:form onsubmit="return isValidForm()" method="Post" action="/AlertreceiverListAction.do?method=updateAlertreceiverList"><!---->
  ...
  <template:formTable>
    <template:formTr name="接收事故级别">
      <html:select property="emergencylevel" styleClass="inputtext" style="width:160px">
        ...
        <logic:notEmpty name="reclist">
          ...
          <logic:present name="reclist">
              <select name="userworkId"   style="display:none;width:160px">
                <logic:iterate id="receiverId" name="reclist">
          ...
          <logic:present name="reclist">
          <template:formTr name="接收报警号码" tagID="conTr" isOdd="false">
               <input name="simcode" class="inputtext" style="width:160px" maxlength="11"/>
          </template:formTr>
          </logic:present>
