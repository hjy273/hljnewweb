...
</tr>  <tr><td height="2" background="${ctx}/images/bg_line.gif"><img src="${ctx}/images/1px.gif" width="1px" height="1"></td> </tr></table>
  ...
  <table width="98%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
    ...
    <tr class=trcolor >
      <td valign="top" class="tdulleft">
        <select name="select" multiple="multiple" size="5" style="width:160px;height:80px" class="multySelect">
        </select>
		<br>
      ...
      <td class="tdulright">
      <select name="select2" multiple="multiple" size="5" style="width:160px;height:80px" class="multySelect">
      </select>
      <br>
