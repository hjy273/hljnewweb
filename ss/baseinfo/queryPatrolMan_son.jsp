...
<html:form method="Post" action="/patrolSonAction.do?method=queryPatrolSon">
  <template:formTable contentwidth="200" namewidth="300">
	...
	<c:if test="${LOGIN_USER.deptype=='2'}">
		  <select name="parentID" class="inputtext" style="width:180px;display:none" id="cId" >
              <option value="${LOGIN_USER.deptID}" selected="selected"></option>
            </select>
	</c:if>
   ...
   <logic:present name="uinfo">
    ...
    <template:formTr name="性&nbsp;&nbsp;&nbsp;&nbsp;别">
      <html:select property="sex" styleClass="inputtext" style="width:180px">
        <html:option value="">不限</html:option>
        <html:option value="1">男</html:option>
        <html:option value="2">女</html:option>
      </html:select>
    </template:formTr>
   <template:formTr name="工作状态"  isOdd="false">
      <html:select property="jobState" styleClass="inputtext" style="width:180px">
        <html:option value="">不限</html:option>
