...
List groupCollection = statdao.getSelectForTag("patrolname","patrolid","patrolmaninfo",condition);
...
<html:form onsubmit="return isValidForm()" method="Post" action="/patrolSonAction.do?method=updatePatrolSon">
  <template:formTable >
    ...
    <template:formTr name="性  别" isOdd="false">
    ...
    <logic:equal value="1" name="LOGIN_USER" property="deptype">
      <template:formTr name="单位名称" isOdd="false">
    ...
    <logic:equal value="2" name="LOGIN_USER" property="deptype">
      <template:formTr name="单位名称">
        <select name="parentID" Class="inputtext" style="width:200px">
    ...
    <template:formTr name="固定电话" isOdd="false">
      <html:text property="phone" styleClass="inputtext" style="width:200px" maxlength="12"/>
    </template:formTr>
    <template:formTr name="移动电话">
      <html:text property="mobile" styleClass="inputtext" style="width:200px" maxlength="12"/>
    </template:formTr>
    ...
    <template:formTr name="邮政编码">
      ...
      <html:text property="postalcode" styleClass="inputtext" style="width:200px" maxlength="6"/>
    </template:formTr>
    <template:formTr name="身份证号" isOdd="false">
      <html:text property="identityCard" styleClass="inputtext" style="width:200px" maxlength="18"/>
    </template:formTr>

   <template:formTr name="管理范围">
      <!-- 改单行为多行显示.Add by Steven Mar 16,2007 -->
      <html:textarea property="familyAddress" styleClass="textarea" style="width:280px;" rows="2" cols=""></html:textarea>
   </template:formTr>
    <template:formTr name="工作经历" isOdd="false">
      <!-- 改单行为多行显示.Add by Steven Mar 16,2007 -->
      <html:textarea property="workRecord" styleClass="textarea" style="width:280px;" rows="2" cols="" ></html:textarea>
    </template:formTr>
