...
<display:table name="sessionScope.queryresult" requestURI="${ctx}/sublineAction.do?method=querySubline" id="currentRowObject" pagesize="15">
  ...
  <display:column property="contractorname" title="维护单位" sortable="true"/>
