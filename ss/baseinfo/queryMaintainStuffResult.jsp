...
function toDelete(idValue){
    if(confirm("确定删除该纪录？")){
        var url = "${ctx}/MaintainStuffAction.do?method=deleteMaintainStuff&id=" + idValue;
...
<display:table name="sessionScope.queryresult" id="currentRowObject" pagesize="18">
  <display:column property="id" title="设备编号" href="${ctx}/MaintainStuffAction.do?method=loadMaintainStuff" paramId="id"/>
