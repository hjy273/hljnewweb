...
<%@page import="com.cabletech.partmanage.beans.*,com.cabletech.baseinfo.domainobjects.UserInfo" %>
<script>
...
<template:titile value="查询所有申请单信息"/>
<html:form onsubmit="return isValidForm()" method="Post" action="/PartRequisitionAction.do?method=showAllRequisition">
