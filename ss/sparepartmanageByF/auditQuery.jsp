...
<html>
	...
	<body>
		<br>
		<template:titile value="按条件查询备件审核信息" />
		<html:form action="/SparepartApplyAction.do?method=doQueryForAu" styleId="queryForm">
			<template:formTable namewidth="200" contentwidth="200">
				...
				<template:formTr name="审核结果:">
					<select name="auditing_result" class="inputtext" style="width:250;">
