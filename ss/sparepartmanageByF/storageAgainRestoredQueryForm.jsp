...
<html>
	...
	<body>
		<br>
		<template:titile value="按条件查询备件重新入库信息" />
		<html:form action="/SparepartStorageAction.do?method=doQueryForAgainRestored" styleId="queryForm">
			...
			<!--  	<template:formTr name="备件库存位置">
					<input name="init_storage" class="inputtext" type="text"
						style="width:250;" maxlength="25" />
				</template:formTr>-->
