...
<html:form method="Post" action="/smsLogAction.do?method=querySMS_ReciveLog" styleId="form">
  <template:formTable contentwidth="300" namewidth="280">
    ...
    <template:formTr name="发送设备手机号码" isOdd="false" >
    ...
    <template:formTr name="开始日期">
      <html:text property="begindate" styleClass="Wdate required" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd'})" style="width:180;"  readonly="true"/>
    </template:formTr>
    <template:formTr name="结束日期" isOdd="false">
      <html:text property="enddate" styleClass="inputtext" style="width:180;" readonly="true"/>
    </template:formTr>
    <template:formSubmit>
      <td>
