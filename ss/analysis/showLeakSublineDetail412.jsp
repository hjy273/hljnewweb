...
<div class='title2' style='font-size:14px; font-weight:600;bottom:1' align='center'><%=request.getAttribute("conName412") %>本月漏做巡检任务之线段显示结果</div><hr width='100%' size='1'>
...
<display:table name="sessionScope.leakSublineDetail412"   id="currentRowObject"  pagesize="18">
   ...
   <center>
   <input type="button" onclick="location.replace('<%=session.getAttribute("S_BACK_URL")%>')" value="返回" />
   </center>
