...
<script language="javascript">
	...
	function addGoBack(){
		 var url = "${ctx}/datum/querysystemfile.jsp";
      	self.location.replace(url);
	}
</script>
</head>
<body>
<template:titile value="修改代维制度" />
<html:form action="/DatumSystemAction?method=updateDatumSystem"  onsubmit="return validate(this);" enctype="multipart/form-data">
<template:formTable namewidth="150" contentwidth="350">
<html:hidden property="id" name="datumsystem"/>
<html:hidden property="adjunct" name="datumsystem"/>
<template:formTr name="文档名称">
<html:text property="documentname" name="datumsystem" styleClass="inputtext" style="width:250;" maxlength="25" />
</template:formTr>
...
<html:select property="documenttype" name="datumsystem" styleClass="inputtext" style="width:160">
  <html:options collection="documenttypecoll" property="value" labelProperty="label"/>
</html:select>
</template:formTr>
<template:formTr name="文档描述">
<html:textarea property="description" name="datumsystem" cols="36" onkeyup="this.value=this.value.substr(0,250)" rows="3" style="width:250" styleClass="textarea" title="描述信息最长250个汉字"/>
</template:formTr>
<template:formTr name="有效期">
<html:text property="validatetime" name="datumsystem" styleClass="Wdate" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd'})" style="width:250;" maxlength="26" />
</template:formTr>
<template:formTr name="附件">
<table id="uploadID"  border="0" align="left" cellpadding="0" cellspacing="0" >
	<tr class=trcolor>
    <td>
      <logic:empty name="datumsystem"  property="adjunct">
      </logic:empty>
      <logic:notEmpty name="datumsystem" property="adjunct">
        <bean:define id="temp" name="datumsystem" property="adjunct" type="java.lang.String"/>
