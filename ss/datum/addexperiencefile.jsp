...
<body>
<br>
<template:titile value="添加代维经验" />
<html:form action="/DatumExperienceAction?method=addDatumExperience"  onsubmit="return validate(this);" enctype="multipart/form-data">
<template:formTable namewidth="150" contentwidth="350">
<template:formTr name="代维经验名称">
<html:text property="documentname" styleClass="inputtext" style="width:250;" maxlength="25" />
</template:formTr>
<template:formTr name="代维经验类型">
