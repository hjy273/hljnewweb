...
<div class='title2' style='font-size:14px; font-weight:600;bottom:1' align='center'>
	${CMMonthlyStatConBean.endYear }年各线路级别巡检率对比图
</div>
<hr width='100%' size='1'>
<table width='100%'>
 <tr>
 <td valign="top" align="center" width="20%">
	...
	<tr>
		<td>
				<iframe style="color:#EAE9E4" marginWidth="0" marginHeight="0" id="monthcontrast"
					src="${ctx}/whole_net_stat.do?method=showLineLevelYearPatrolRateChart&&width=700&&height=250" frameBorder=0 width="100%" scrolling=auto height="250px">
				</iframe>
		</td>
	</tr>
</table>
