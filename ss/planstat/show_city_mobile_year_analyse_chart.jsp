...
function ck(id){
  ...
  if (id=="1"){
	document.getElementById("monthcontrast").src ="${ctx}/city_mobile_year_stat.do?method=showYearContractorPatrolRateChart&&width=3700&&height=250";
  }
  if (id=="2"){
	document.getElementById("monthcontrast").src ="${ctx}/city_mobile_year_stat.do?method=showYearContractorLineLevelPatrolRateChart&&width=3700&&height=250";
  }
}
//-->
</script>
<div class='title2' style='font-size: 14px; font-weight: 600; bottom: 1'
	align='center'>
	多个代维公司${CMMonthlyStatConBean.endYear }年巡检率对比图
</div>
<hr width='100%' size='1'>
<table width='100%'>
	<tr>
	...
	<tr>
		<td>
			<iframe style="color: #EAE9E4" marginWidth="0" marginHeight="0"
				id="monthcontrast"
				src="${ctx}/city_mobile_year_stat.do?method=showYearContractorPatrolRateChart&&width=3700&&height=250"
