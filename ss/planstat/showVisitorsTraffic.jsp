...
function addGoBack()
{
  var url="${ctx}/planstat/queryVisitorsTraffic.jsp";
...
<table class="ooib" id="obody" border="0" cellspacing="0" cellpadding="0" width="100%" height="94.43%">
  <tr>
    <td>
      <div>
          <iframe name="myvisitorstraffictext" marginWidth="0" marginHeight="0" src="${ctx}/planstat/showVisitorsTrafficText.jsp" frameBorder=0 width="100%" scrolling=auto height="100%"> </iframe>
      </div>
    </td>
  </tr>
  <tr style="display: none">
    <td>
     <div>
         ...
         <br>
         <iframe name=treemenu border=0 marginWidth=0 marginHeight=0 src="${ctx}/ShowVisitorsTrafficChart" frameBorder=0 width="100%" scrolling=NO height="100%">        </iframe>
      </div>
    </td>
  </tr>
</table>
...
<table class="ooih" border="0" cellspacing="0" cellpadding="0" width="400" height="19">
  <tr>
    ...
    <td class="ooihs" nowrap onclick="addGoBack()" >返回查询页面</td>
    <td width="100%">&nbsp;</td>
  </tr>
</table>
