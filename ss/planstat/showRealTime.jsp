...
function addGoBack()
{
  var url="${ctx}/planstat/showRealTime.jsp";
...
<table class="ooib" id="obody" border="0" cellspacing="0" cellpadding="0" width="100%" height="94.43%">
  <tr>
    <td>
      <div>
          <iframe name="myrealtimetext" marginWidth="0" marginHeight="0" src="${ctx}/planstat/showRealTimeText.jsp" frameBorder=0 width="100%" scrolling=auto height="100%"> </iframe>
      </div>
    </td>
  </tr>
  <tr style="display: none">
    <td>
     <div>
         ...
         <br>
         <iframe name=treemenu border=0 marginWidth=0 marginHeight=0 src="${ctx}/ShowRealTimeChart" frameBorder=0 width="100%" scrolling=NO height="100%">        </iframe>
      </div>
    </td>
  </tr>
</table>
