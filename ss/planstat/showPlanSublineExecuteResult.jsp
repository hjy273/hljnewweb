...
<display:table name="sublinepatrollist"  id="currentRowObject">
...
<div align="center">
<input name="btnClose" value="关闭" class="button" type="button" onclick="closePlanSublineExecuteResultWin();" />
</div>
