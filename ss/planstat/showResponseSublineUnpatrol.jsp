...
<div class='title2' style='font-size:14px; font-weight:600;bottom:1' align='center'><%=sublineName %>截止今日<%=requestTime %>未巡检点列表</div><hr width='100%' size='1'>
<display:table name="sessionScope.sublineUnpatrol"   id="currentRowObject"  pagesize="16">
	 ...
	 <display:column property="lacktimes" title="尚需巡检次数" sortable="true"/>
