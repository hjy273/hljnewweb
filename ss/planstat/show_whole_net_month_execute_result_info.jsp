...
<div class='title2' style='font-size: 14px; font-weight: 600; bottom: 1'
	...
	年
	<bean:write name="CMMonthlyStatConBean" property="endMonth" />
	月统计详细信息
</div>
<hr width='100%' size='1'>
<br>
<display:table name="month_execute_result_list" id="currentRowObject">
	...
	<display:column property="sublinekm" title="计划路由长度（km）"
		sortable="true" />
	<display:column property="patrolkm" title="巡回路由长度（km）"
		sortable="true" />
</display:table>
