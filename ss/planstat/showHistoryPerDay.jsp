...
function addGoBack()
{
  var url="${ctx}/planstat/showHistoryDaysList.jsp";
...
<table class="ooib" id="obody" border="0" cellspacing="0" cellpadding="0" width="100%" height="94.43%">
  <tr>
    <td>
      <div>
          <iframe name="myhistorytext" marginWidth="0" marginHeight="0" src="${ctx}/planstat/showHistoryPerDayText.jsp" frameBorder=0 width="100%" scrolling=auto height="100%"> </iframe>
      </div>
    </td>
  </tr>
  <tr style="display: none">
    <td>
     <div>
         ...
         <br>
         <iframe name=treemenu border=0 marginWidth=0 marginHeight=0 src="${ctx}/ShowHistoryChart" frameBorder=0 width="100%" scrolling=NO height="100%">        </iframe>
      </div>
    </td>
  </tr>
</table>
...
<table class="ooih" border="0" cellspacing="0" cellpadding="0" width="400" height="19">
  <tr>
    ...
    <td class="ooihs" nowrap onclick="addGoBack()">返回上一页面</td>
