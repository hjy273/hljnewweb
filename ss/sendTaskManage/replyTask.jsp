...
<%@ page import="com.cabletech.sendtask.beans.*,org.apache.commons.beanutils.DynaBean;" %>
...
//		alert("对不起，这个任务的指定处理人不能您，所以不能回复！");
//		return;
//	}
...
<body>
  ...
  <!--显示待回复派单信息-->
			...
			<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0"  class="tabout">
			        	<tr class=trcolor heigth="40">
			                ...
			                <td class="tdl"  width="18%">
			                	...
			                	<html:hidden property="sendtype" name="bean" value="<bean:write property="sendtype" name="bean" />" />
			                </td>
			                <td class="tdr"  width="10%">处理时限</td>
			                <td class="tdl" >
			                	<bean:write property="processterm" name="bean" />
				                  <html:hidden property="processterm" name="bean" value="<bean:write property="processterm" name="bean" />"/></td>
			        	</tr>
			        	...
			        	<tr class=trcolor heigth="40">
			                ...
			                <td class="tdl" width="18%"> 
			                	...
			                	<html:hidden property="sendtime" name="bean" value="<bean:write property="sendtime" name="bean" />" />
			                </td>
			                <td class="tdr"  width="10%">派单部门</td>
	                        <td class="tdl" width="18%">
	                        	<bean:write property="senddeptname" name="bean" />
	                        	<html:hidden property="senddeptname" name="bean" value="<bean:write property="senddeptname" name="bean" />"/>
	                        </td>
	                        <td class="tdr"  width="10%">派 单 人</td>
	                        <td class="tdl" >
	                        	  <bean:write property="username" name="bean" />
				                  <html:hidden property="username" name="bean" value=" <bean:write property="username" name="bean" />"/>
				            </td>
			        	...
			        	<tr class=trcolor heigth="40">
			                ...
			                <td class="tdl"  width="18%">
	                        	...
	                        	<input readonly="readonly" type="hidden"  value="<bean:write name="LOGIN_USER_DEPT_NAME"/>" />
							</td>
			                <td class="tdr" width="10%" >受 理 人</td>
			                <td class="tdl" >
			                	 <bean:write property="usernameacce" name="bean" />
				                 <html:hidden property="usernameacce" name="bean" value="<bean:write property="usernameacce" name="bean" />"/>
				            </td>
			            ...
			            <tr class=trcolor heigth="40" >
			                ...
			                <td class="tdl"  colspan="5" >
			                	...
			                	<html:hidden property="sendtopic"  name="bean" value="<bean:write property="sendtopic" name="bean" />"/>
			                </td>
			        	</tr>
			             ...
			             <tr class=trcolor heigth="40">
			                ...
			                <td class="tdl"  colspan="5">
			                	...
			                	<html:hidden property="sendtext"  name="bean" value="<bean:write property="sendtext" name="bean" />" />
			                </td>
			        	</tr>
	                    ...
	                    <tr class=trcolor heigth="40">
	                        ...
	                        <td class="tdl">
	                        	...
	                        	<html:hidden property="result" name="bean" value="<bean:write property="result" name="bean" />"/>
	                        </td>
	                        <td class="tdr"  width="10%">签收时间</td>
	                        <td  class="tdl">
	                        	<logic:notEmpty name="endorsebean">
	                        	<bean:write property="time" name="endorsebean" />
	                        	<html:hidden property="time" name="endorsebean" value="<bean:write property="time" name="bean" />"/>
	                        	</logic:notEmpty>
	                        </td>
	                    ...
	                    <logic:notEmpty name="endorsebean">
	                    	 ...
	                    	 <tr class=trcolor heigth="40">
		                        ...
		                        <td class="tdl" colspan="5">
		                        	...
		                        	<html:hidden property="remark"  name="endorsebean"  value="<bean:write property="remark" name="endorsebean" />"/>
		                        </td>
		                     </tr>
	                         <tr class=trcolor heigth="40">
       ...
       <logic:equal value="1" name="state" scope="session">  
         <template:titile value="派单回复"/>
			...
			<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0"  class="tabout">
						...
						<%
							List beanList = (List)request.getSession().getAttribute("beanList"); 
							int length = beanList.size();
							for(int i = 0; i < length; i++) {
								DynaBean taskbean = (DynaBean)beanList.get(i);
								String valitime = (String)taskbean.get("validatetime");
								String valiRes = (String)taskbean.get("validateresult");
								String valiRe = (String)taskbean.get("validateremark");
								String replyid = (String)taskbean.get("replyid");
								if(valiRe == null) {
									valiRe = "";
								}
								String valiAcc = (String)taskbean.get("validateacce"); 
								if(valiAcc == null) {
									valiAcc = "";
								}
		                	...
		                	<tr heigth="40" class=trcolor>
		                        ...
		                        <td class="tdl"  colspan="5">
		                        	 <apptag:listAttachmentLink fileIdList="<%=valiAcc%>"/>
	                            </td>
		                	</tr>
	                    ...
	                    <tr heigth="40" class=trcolor>
	                    	<td class="tdr"  width="width="10%"" >回复结果</td>
	                        <td class="tdl" colspan="5">
		                        <select name="replyresult"  style="width:180" class="inputtext">
		                        			<option value="全部完成">全部完成</option>
				                       		<option value="基本完成">基本完成</option>
	                    ...
	                    <tr heigth="40" class=trcolor>
	                    	<td class="tdr"  width="width="10%"" >回复备注</td>
    ...
    <logic:equal  name="type" scope="session" value="10">
      	<br>
		<template:titile value="派单回复详细信息"/>

			<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0"  class="tabout">
			        	<tr class=trcolor heigth="40">
			        		<td class="tdr"  width="11%">工作单类别</td>
			                <td class="tdl"  width="18%">
        ...
        <html:form action="/ReplyAction.do?method=upReply" styleId="addApplyForm"  onsubmit="return validate(this)" enctype="multipart/form-data">
             ...
             <table width="90%" border="0" align="center" cellpadding="3" cellspacing="0"  class="tabout">
			        	<tr class=trcolor heigth="40">
			                ...
			                <td class="tdl"  >
			                	<bean:write property="processterm" name="bean"/>
				            	<html:hidden property="processterm" name="bean" value="<bean:write property="processterm" name="bean"/>"/>
				            </td>
			        	</tr>
			        	...
			        	<tr heigth="40" class=trcolor >
			                ...
			                <td class="tdl"  width="18%">
			                	<bean:write name="LOGIN_USER_DEPT_NAME"/>
	                        	<input type="hidden" value="<bean:write name="LOGIN_USER_DEPT_NAME"/>"/>
							</td>
			                <td class="tdr" width="10%" >受 理 人</td>
			                <td class="tdl">
			                	<bean:write property="usernameacce" name="bean"/>
	                    ...
	                    <tr class=trcolor heigth="40">
	                        ...
	                        <td colspan="3" class="tdl">
	                        	<bean:write property="time" name="endorsebean"/>
	                        	<html:hidden property="time" name="endorsebean" value="<bean:write property="time" name="endorsebean"/>"/>
	                        </td>
	                    ...
	                    <tr class=trcolor heigth="40"> 
	                        ...
	                        <td class="tdl" >
		                       ...
		                       <html:hidden property="replytime" name="replybean" value="<bean:write property="replytime" name="replybean"/>"/>
		                    </td>

                            <td class="tdr"  width="10%">工作状态</td>
	                        <td class="tdl">
	                        	<bean:write property="workstate" name="bean"/>
	                        	<html:hidden property="workstate" name="bean" value="<bean:write property="workstate" name="bean"/>" />
	                        </td>
                        </tr>
	                    <tr class=trcolor heigth="40">
	                    	<td class="tdr"  width="10%" >回复备注</td>
	                    ...
	                    <tr class=trcolor heigth="40">
			                ...
			                <td class="tdl"  colspan="5">
			                	 <%
								    ...
								    %>
							      <apptag:listAttachmentLink fileIdList="<%=replyacce%>" showdele="true"/>
                                  <table id="uploadID" width="70%" border="0" align="left" cellpadding="3" cellspacing="0" >
							          <tbody></tbody>
			                     </table>
			                </td>
		...
		<html:form action="/ReplyAction?method=forwardTask" styleId="addApplyForm"  enctype="multipart/form-data">
        	...
        	<table id="tableID" width="90%" border="0" align="center" cellpadding="3" cellspacing="0"  class="tabout">
		        <tr class=trcolor heigth="40">    
	                ...
	                <td class="tdr" width="10%">处理时限</td>		                
	                <td class="tdl"  >
	                	<html:hidden name="bean" property="processterm" />
						<bean:write name="bean" property="processterm"/>
                    </td>                       
		        </tr>
		        <tr class=trcolor heigth="40">		        		
	            ...
	            <tr class=trcolor heigth="40">
	                ...
	                <td class="tdl"  colspan="3">
					    <%
					      String sendacces = "";
					      SendTaskBean beans = (SendTaskBean) request.getSession().getAttribute("bean");
					      sendacces = beans.getSendacce();
					      if (sendacces == null) {
					        sendacces = "";
					      }
					    %>
					      <apptag:listAttachmentLink fileIdList="<%=sendacces%>"/>
