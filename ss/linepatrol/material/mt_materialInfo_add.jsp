...
<body>
	<div id="groupDivId">
		...
		<html:form onsubmit="return isValidForm();" method="Post"
			action="/materialInfoAction.do?method=addPartBase" styleId="materialInfoBean">
			<template:formTable contentwidth="260" namewidth="260">
				<template:formTr name="材料名称">
					<html:text property="name" styleClass="inputtext" style="width:205px"
						maxlength="50" />
				</template:formTr>
				...
				<template:formTr name="生产厂家">
					<html:text property="factory" styleClass="inputtext"
						style="width:205px" maxlength="200" />
				</template:formTr>
				<template:formTr name="备注">
					 <html:textarea property="remark" styleClass="inputtext" style="width:270px;height:100px;" cols="10" rows="10"/>
				</template:formTr>
				<template:formSubmit>
					<td>
