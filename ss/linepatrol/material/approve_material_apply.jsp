...
<html>
	...
	<body>
		...
		<html:form action="/material_apply.do?method=approveMaterialApply" styleId="approveMaterialApply">
			<center>
	...
	jQuery("#approveMaterialApply").bind("submit",function(){processBar(approveMaterialApply);});
})
	</script>
	</body>
</html>
