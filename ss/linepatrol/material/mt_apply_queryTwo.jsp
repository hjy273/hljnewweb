    ...
    <html:form action="/LinePatrolManagerAction.do?method=queryParolManagerList" >
  	<template:formTable namewidth="150" contentwidth="300">
  		...
  		<template:formTr name="材料来源">
         				...
         				<option value="1">新增材料</option>
         				<option value="0">利旧材料</option>
         				<option value="2">自购材料</option>
         				</select>
  		</template:formTr>
  		<template:formTr name="审批类型">
  				<select name="state" class="inputtext" style="width:215px" id="typeID">
  						<option value="">选择所有状态</option>
         					<option value="1">待审批</option>
         					<option value="2">不予通过</option>
