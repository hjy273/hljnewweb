...
<html>
	<head>
		...
		exportList=function(){
			...
			var url="${ctx}/materialStockAction.do?method=exportStoksList&p=mt&new="+newstock+"&old="+oldstock+"&sum="+sum;
			self.location.replace(url);
		}
		
		function  goBack(){
			var url="${ctx}/materialStockAction.do?method=queryMaterialStrockByMTForm";
			self.location.replace(url);
		}
		</script>
		<title>材料库存</title>
	...
	<body>
		...
		<template:titile value="材料库存一览表" />
			<display:table varTotals="totalMap" name="sessionScope.marterialStocksMT" id="currentRowObject" pagesize="18">
...
<td>
	 合计:
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="border:0px">		
		    <tr>
		    	<td>
		    		 <logic:notEmpty name="marterialStocksMT">
