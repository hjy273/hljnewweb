...
<html>
	...
	<link href="${ctx}/css/linepatrol_css.css" rel="stylesheet"
		type="text/css">
	<body>
		<template:titile value="移动确认材料入库单" />
		<html:form action="/material_put_storage.do?method=approveMaterialPutStorage" styleId="approveMaterialPutStorage">
			<center>
              ...
              自购材料
					...
					<tr class=trcolor>
						...
						<td colspan="5" class="tdl">
							<input value="1" type="radio" name="approveResult" checked>
							通过审核
							<input value="0" type="radio" name="approveResult">
							不予通过
						</td>
					</tr>
					<tr class=trcolor>
						...
						<td colspan="3" class="tdl">
							<textarea rows="" style="width:500px" Class="inputtextarea"
	...
	jQuery("#approveMaterialPutStorage").bind("submit",function(){processBar(approveMaterialPutStorage);});
})
	</script>
	</body>
</html>
