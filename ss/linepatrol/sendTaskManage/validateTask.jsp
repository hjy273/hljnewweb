...
<!--显示派单验证的详细信息,进行验证-->
    <logic:equal  name="type" scope="session" value="20">
		...
		<logic:present name="validate_list" scope="session">
			<tr class="trcolor">
				<td align="right" class="tdulleft">
					验证信息
				</td>
				<td align="left" class="tdulleft" colspan="5">
					&nbsp;
				</td>
			</tr>
			<tr class="trcolor">
				<td align="center" colspan="6" id="applyAuditingTd"
					class="tdulright">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<logic:iterate id="auditingItem" name="validate_list" scope="session">
							<tr>
								<td>
									<bean:write name="auditingItem" property="validateusername" />
								</td>
								<td>
									<logic:equal name="auditingItem" property="validateresult"
										value="通过验证">
										通过验证
									</logic:equal>
									<logic:equal name="auditingItem" property="validateresult"
								...
								<td>
									<bean:write name="auditingItem" property="validatetime" />
								</td>
								<td>
									<bean:write name="auditingItem" property="validateremark" />
								</td>
								<td>
									<apptag:upload cssClass="" entityId="${auditingItem.validateid}" entityType="LP_VALIDATEREPLY" state="look"/>
								</td>
							</tr>
						</logic:iterate>
					</table>
	                    ...
	                    <tr class=trcolor height="40">
			                ...
			                <td class="tdl"  colspan="5">
			                    <apptag:upload cssClass="" entityId="" entityType="LP_VALIDATEREPLY" state="add"/>
			                </td>
			        	</tr>
			        </table>
                    <table align="center">
				...
				<tr class=trcolor height="40">
					...
					<td class="tdl" colspan="5">
	                    ...
	                    <tr class=trcolor height="40">
			            	<td class="tdr"  width="10%">反馈附件</td>
			                <td class="tdl"  colspan="5">
			                	 <apptag:upload cssClass="" entityId="${sessionScope.replybean.id}" entityType="LP_SENDTASKREPLY" state="look"/>
			                </td>
			        	</tr>
		<logic:present name="validate_list" scope="session">
			<tr class="trcolor">
			...
			<tr class="trcolor">
				<td align="center" colspan="6" id="applyAuditingTd"
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<logic:iterate id="auditingItem" name="validate_list">
							<tr>
								<td>
									<bean:write name="auditingItem" property="validateusername" />
								</td>
