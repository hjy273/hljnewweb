...
<body onload="changeStyle();getTroubleCode()">
	<template:titile value="隐患登记" />
	<html:form action="/hiddangerAction.do?method=terminalRegist" styleId="form" onsubmit="return check()">
		...
		<template:formTable namewidth="150" contentwidth="300">
			...
			<template:formTr name="发现隐患来源">
				<html:text property="reporter" styleId="reporter" styleClass="inputtext required" style="width:140px"/>
			</template:formTr>
			<template:formTr name="隐患处理单位">
				<html:select property="treatDepartment" styleId="treatDepartment" styleClass="inputtext required" style="width:140px">
			...
			<template:formSubmit>
				...
				<td>
					<html:reset property="button" styleClass="button" onclick="history.back()">返回</html:reset>
				</td>
			</template:formSubmit>
		</template:formTable>
		<jsp:include page="note.jsp" />
		<apptag:viewPicture entityId="${registBean.id}" entityType="LP_HIDDANGER_REGIST" width="200" height="150" number="5"></apptag:viewPicture>
	</html:form>
	<script type="text/javascript">
