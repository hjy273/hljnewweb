	...
	<html:form action="/hiddangerAction.do?method=addRegist" styleId="form" onsubmit="return check()">
		<template:formTable namewidth="150" contentwidth="300">
			...
			<template:formTr name="隐患坐标位置">
				...
				<input type="text" name="position" id="position" style="width:140px" class="inputtext required validate-pattern-/^\d+.\d+,\d+.\d+$/" /><input type="button" value="选择" onclick="chooseMap()"/>
			</template:formTr>
