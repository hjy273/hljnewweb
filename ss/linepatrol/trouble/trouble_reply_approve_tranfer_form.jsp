...
<html>
	...
	<body>
		<br>
		<template:titile value="故障转审" />
		<html:form action="/replyApproveAction.do?method=approveReply"
			styleId="approveReply" onsubmit="return checkAddInfo();">
			...
			<input type="hidden" name="troubleid"
				value="<bean:write name="bean" property="tid"/>" />
			<input type="hidden" id="replyid" name="objectId" 
				value="<bean:write name="reply" property="id"/>" />
			<table width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
				...
				<tr class=trcolor>
					<td colspan="6">
						<div id="showdetail">
							<a href="javascript:viewReplyDetail('1');">查看详细信息</a>
						</div>
						<div id="hiddendetail" style="display: none">
							<a href="javascript:viewReplyDetail('2');">隐藏详细信息</a>
						</div>
					</td>
				</tr>
			<tbody id="replydetail" style="display:none">
					...
					<tr class=trwhite>
						...
						<td colspan="5" style="word-break:break-all;width:500px;" >
						  ...
						  <tr class=trcolor>
						    ...
						    <td class="tdulright" colspan="5" ><c:out value="${reply.reportCaseComment}"></c:out>
						  </tr>
						  <tr class=trcolor>
					...
					<tr class=trcolor>
						...
						<td class="tdulright" colspan="5"><apptag:upload cssClass="" entityId="${reply.id}" entityType="LP_TROUBLE_REPLY" state="look"/></td>
					</tr>
			<tr class=trwhite>
						<td class="tdulleft">
							备注：
					 ...
					 <logic:notEmpty name="approves">
					  ...
					  <tr class=trwhite>
					  	<td colspan="4">
					  	<table width="100%"><tr>
					 	<td width="7%">审核人</td><td width="15%">审核时间 </td>
					 	<td width="8%">审核结果 </td><td width="40%">审核意见 </td><td width="30%">附件</td>
					 </tr>
				...
				<tr class=trwhite>
					...
					<td class="tdulright" colspan="3" style="text-align: left;">
						<textarea name="approveRemark" rows="6" class="max-length-256" style="width: 500px;"></textarea>
					</td>
				</tr>
