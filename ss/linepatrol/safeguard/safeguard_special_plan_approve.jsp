...
<template:titile value="特巡计划审核"/>
<html:form action="/specialEndPlanAction.do?method=approveSpecialPlan" styleId="approveSpecialPlan">
  ...
  <tr class=trcolor>
    ...
    <td class="tdulright" >
      <div id="TabbedPanels1" class="TabbedPanels">
		...
		<input type="hidden" name="spplan" value="${planId }"/>
