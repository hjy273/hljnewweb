		...
		<table  width="90%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
			...
			<tr class=trcolor>
				...
				<td class="tdulright" colspan=3>
					<html:text property="workName" styleClass="inputtext required" style="width:130px" value="${pipe.projectName}" />
				</td>
			</tr>
			<tr class=trcolor>
				<td class="tdulleft">管道地点：</td>
				<td class="tdulright"><html:text property="pipeAddress" styleClass="inputtext required" value="${pipe.pipeAddress}" style="width:130px"/></td>
				<td class="tdulleft">产权属性：</td>
				<td class="tdulright"><apptag:quickLoadList cssClass="input" style="width:130px" name="routeRes" keyValue="${pipe.pipeProperty}" listName="property_right" type="select"/></td>
			</tr>
			<tr class=trcolor>
				<td class="tdulleft">详细路由：</td>
				<td class="tdulright"><html:text property="pipeLine" styleClass="inputtext required" value="${pipe.pipeRoute}" style="width:130px"/></td>
				<td class="tdulleft">竣工图纸：</td>
				<td class="tdulright"><html:text property="picture" value="${pipe.workingDrawing}" styleClass="inputtext required validate-number" style="width:130px"/></td>
			</tr>
			<tr class=trcolor>
				<td class="tdulleft">管道中心项目经理：</td>
				<td class="tdulright"><html:text property="principle" value="${pipe.pcpm}" styleClass="inputtext required" style="width:130px"/></td>
				<td class="tdulleft">管道属性：</td>
				<td class="tdulright"><apptag:quickLoadList cssClass="input" style="width:130px" name="pipeType" keyValue="${pipe.pipeType}" listName="pipe_type" type="select"/></td>
			</tr>
			<tr class=trcolor>
				...
				<td class="tdulright" colspan=3><html:textarea style="width:250px;height:50px" property="remark" value="${pipe.remark}" styleClass="required"/></td>
			</tr>
			<tr class=trcolor>
				<td class="tdulleft">移动长度：</td>
				<td class="tdulright" colspan=5>
					沟（公里）<html:text property="mobileScareChannel" value="${pipe.moveScale0}" styleClass="inputtext required validate-number" style="width:130px"/>
					&nbsp;&nbsp;&nbsp;&nbsp;孔（公里）<html:text property="mobileScareHole" value="${pipe.moveScale1}" styleClass="inputtext required validate-number" style="width:130px"/>
				</td>
			</tr>
			<tr class=trcolor>
				<td class="tdulleft">管道长度：</td>
				<td class="tdulright" colspan=5>
					沟（公里）<html:text property="pipeLengthChannel" value="${pipe.pipeLength0}" styleClass="inputtext required validate-number" style="width:130px"/>
					&nbsp;&nbsp;&nbsp;&nbsp;孔（公里）<html:text property="pipeLengthHole" value="${pipe.pipeLength1}" styleClass="inputtext required validate-number" style="width:130px"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tdulright"><html:text property="maintenceUnit" value="${LOGIN_USER.deptName}" styleClass="inputtext required max-length-100" style="width:130px" /></td>
				<td class="tdulleft">验收人员：</td>
