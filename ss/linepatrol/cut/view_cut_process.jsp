...
<html>
	<head>
		...
		toUrl=function(btn,taskName){
			var url="${ctx}/cutAction.do?method=getAllCut&&task_name="+taskName;
			parent.location=url;
		};
		</script>
		<style type="text/css">
			...
			<tr>
				...
				<td>
					<input type="button" id="btnWork" class="button_not_click"
						style="cursor: hand;" value="待反馈割接(${wait_work_num }条)"
				...
				<td>
					<input type="button" id="btnWorkApprove"
						...
						value="待审反馈(${wait_work_approve_num }条)"
			...
			<tr>
				<td>
					<input type="button" id="btnApply" class="button_not_click"
						style="cursor: hand;" value="割接申请(${wait_apply_num }条)"
				...
				<td>
					<input type="button" id="btnApplyApprove"
						class="button_not_click" style="cursor: hand;"
						value="待审申请(${wait_apply_approve_num }条)"
				...
				<td>
					<input type="button" id="btnCheck" class="button_not_click"
						style="cursor: hand;" value="待验收(${wait_check_num }条)"
				...
				<td>
					<input type="button" id="btnCheckApprove"
						class="button_not_click" style="cursor: hand;"
						value="待审验收(${wait_check_approve_num }条)"
