...
<html>
	...
	<body>
		<template:titile value="取消派单" />
		<html:form action="/dispatchtask/dispatch_task.do?method=cancelDispatchTask" method="post"
			styleId="submitForm1">
			<template:formTable>
				<template:formTr name="取消原因" isOdd="false">
					<input name="id" type="hidden" value="${dispatch_id}" />
