		...
		<html:form action="/overHaulAction.do" styleId="form">
			...
			<template:formTr name="割接信息">
				<table width=100% border=1>
					<tr>
						<td align='center' width='15%'>代维</td>
				   		<td align='center' width='40%'>割接名称</td>
						<td align='center' width='15%'>割接费用</td>
			...
			<template:formTr name="工程信息">
				<table width=100% border=1>
					<tr>
						<td align='center' width='15%'>代维</td>
						<td align='center' width='40%'>工程名称</td>
						<td align='center' width='15%'>工程费用</td>
						<td align='center' width='20%'>申请日期</td>
						<td align='center' width='10%'>状态</td>
					</tr>
					<c:forEach var="apply" items="${OverHaul.applys}">
			...
			<template:formSubmit>
				<c:if test="${type eq 'history'}">
					<td>
						<input type="button" class="button" value="流程历史" onclick="his('${OverHaul.id}')" />
					</td>
				</c:if>
					<td>
