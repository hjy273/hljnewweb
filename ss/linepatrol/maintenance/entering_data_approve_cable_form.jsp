	...
	<%
	 ...
	 %>
		   ...
		   <display:table name="sessionScope.planLines"  id="currentRowObject" pagesize="12" >
				...
				<display:column property="segmentname" sortable="true" title="中继段"  maxLength="30" style="width:20%"/>
				...
				<display:column property="username" sortable="true" title="计划测试人" style="width:15%" maxLength="12"/>
