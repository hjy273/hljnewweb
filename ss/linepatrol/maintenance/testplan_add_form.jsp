...
<html>
	...
	<body>
		...
		<template:titile value="制定测试计划" />
		<html:form action="/testPlanAction.do?method=addTestPlan"
			...
			<table width="80%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
				    ...
				    <tr class=trwhite>
				      ...
				      <td class="tdulright" colspan="3">
				          <html:text property="testPlanName" styleClass="required" style="width:205"></html:text>&nbsp;&nbsp;<font color="red">*</font>
				      </td>
				    </tr>
				    <tr class=trcolor>
				    ...
				    <tr class=trwhite>
				      ...
				      <td class="tdulright" colspan="3">
				      <input name="testBeginDate" id="testBeginDate" class="Wdate" style="width:170"
					onfocus="WdatePicker({dateFmt:'yyyy/MM/dd',maxDate: '#F{$dp.$D(\'testEndDate\')}',minDate: '%y-%M-%d-%H-%m-%s'})" readonly/>
				      
				      至
				    
				    <input name="testEndDate" id="testEndDate" class="Wdate" style="width:170"
					onfocus="WdatePicker({dateFmt:'yyyy/MM/dd',minDate: '#F{$dp.$D(\'testBeginDate\')}',minDate: '%y-%M-%d-%H-%m-%s'})" readonly/>&nbsp;&nbsp;<font color="red">*</font>
				    ...
				    <tr class=trcolor>
				      ...
				      <td class="tdulright" colspan="3">				       
				       <html:textarea property="testPlanRemark" styleClass="max-length-512" rows="4" style="width:375px"></html:textarea>	       
				     </td>
				    </tr>
				     <tr class=trwhite>
				    	<apptag:approverselect inputName="approvers,mobiles" label="审核人" colSpan="4" inputType="radio" notAllowName="reads"></apptag:approverselect>
				     </tr>
				      <tr class=trcolor>
				    	<apptag:approverselect inputName="reads,rmobiles" label="抄送人" colSpan="4" spanId="reader" notAllowName="approvers"></apptag:approverselect>
				     </tr>
				    <tr>
