...
<html>
	...
	<body>
	<html:form action="/enteringStationDataAction.do?method=addEnteringStationData" styleId="stationDataform" >
		<table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
		    ...
		    <tr class=trwhite>
		      ...
		      <td class="tdulright">
		       <html:text property="testWeather" styleId="testWeather" styleClass="required" ></html:text>&nbsp;&nbsp;<font color="red">*</font>
		      </td>
		    </tr>
		    <tr class=trcolor>
		      <td class="tdulleft"> 测试人员：</td>
		      <td class="tdulright" colspan="3">
			       <font color="red">*</font><apptag:testman spanId="testMan" hiddenId="tester" state="e" testman="${station.testMan}" tablename="station1"></apptag:testman>
			   </td>
		    </tr>
		     <tr class=trwhite>
		      <td class="tdulleft">测试地点：</td>
		      <td class="tdulright" colspan="3" >
			       <html:text property="testAddress" styleId="testAddress" styleClass="required" style="width:205" ></html:text>&nbsp;&nbsp;<font color="red">*</font>
			   </td>
		    </tr>
		    <tr>
		    ...
		    <tr class=trwhite>
		     ...
		     <tr class=trcolor>
		      ...
		      <td class="tdulright" colspan="3">
		      	<html:text property="resistanceValue" styleId="resistanceValue"></html:text>&Omega;&nbsp;&nbsp;<font color="red">*</font>
		      </td>
		    </tr>
		     <tr class=trwhite>
		    ...
		    <tr class=trcolor>
		      ...
		      <td class="tdulright" colspan="3">
		      		<html:textarea property="problemComment" styleId="problemComment" styleClass="max-length-512" rows="3" style="width:325px"></html:textarea>&nbsp;&nbsp;<font color="red">*</font>
		      </td>
		    </tr>
		    <tr class=trwhite>
		      <td class="tdulleft">处理方法：</td>
		      <td class="tdulright" colspan="3">
					<html:textarea property="disposeMethod" styleId="disposeMethod" styleClass="max-length-512" rows="3" style="width:325px"></html:textarea>&nbsp;&nbsp;<font color="red">*</font>
			  </td>
		    </tr>
		    <tr class=trcolor>
		      <td class="tdulleft">备 注：</td>
		      <td class="tdulright" colspan="3">
		      	<html:textarea property="remark" styleId="remark" styleClass="max-length-512" rows="3" style="width:325px"></html:textarea>
		      </td>
		    </tr>
			  <tr class=trcolor>
			      <td colspan="4" align="center">
			        ...
			        <input type="button" class="button" onclick="checkAddInfo();" value="提交" />
