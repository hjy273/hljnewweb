...
<html>
	...
	<body>
		<html:form action="/testYearPlanAction.do?method=addPlanTask"
			...
			<input type="hidden" name="oldCableLevel" value="${planTask.cableLevel}"/>
		    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
			    <tr  class=trcolor>
			      <td class="tdulleft">光缆级别：</td>
			      <td class="tdulright">
			      	<apptag:quickLoadList cssClass="select" style="width:155px" keyValue="${planTask.cableLevel}" id="cableLevel" name="cableLevel" listName="cabletype" type="select"></apptag:quickLoadList>
				  </td>
			    </tr>
			     <tr  class=trwhite>
			      <td class="tdulleft">变更前测试次数：</td>
			      <td class="tdulright">
			      	<html:text property="preTestNum" styleId="preTestNum" value="${planTask.preTestNum}"></html:text>
			      </td>
			    </tr>
			    <tr  class=trcolor>
			      <td class="tdulleft">申请测试次数：</td>
			      <td class="tdulright">
			        <html:text property="applyNum" styleId="applyNum" value="${planTask.applyNum}"></html:text>
			      </td>
			    </tr>
			      <tr  class=trwhite>
			      <td class="tdulleft">变更中继段：</td>
			      <td class="tdulright">
			      	<apptag:trunk id="trunkIds" value="${planTask.trunkIds}" state="edit"/>
			      </td>
			    </tr>
			    <tr class=trwhite>
