...
<script type="text/javascript">
	...
	function read(){
		var url = '${ctx}/hiddangerAction.do?method=read&id=${hiddangerId}&type=LP_HIDDANGER_MAKEPLAN';
...
<body style="vertical-align:bottom;">
	<template:titile value="盯防计划审核" />
	<form id="add_form" name="add_form" method="post" action="${ctx}/watchAction.do?method=approveWatchPlan">
	...
	<c:choose>
		<c:when test="${!readOnly}">
			<apptag:approve labelClass="tdulleft" areaStyle="width: 300px;" displayType="input" objectId="${specialPlan.id}" objectType="LP_SPECIAL_PLAN" />
			<template:formSubmit>
				<td>
