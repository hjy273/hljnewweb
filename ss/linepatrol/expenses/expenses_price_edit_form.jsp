				  ...
				  <tr class=trcolor >
				  	...
				  	<td class="tdulright" >
				  		...
				  		<c:if test="${expensePriceBean.expenseType=='1'}">
					  		<input type="radio" name="expenseType" value="0"  onclick="judgeExpeseType(this.value)"/>光缆
					  		<input type="radio" name="expenseType" value="1" checked="checked" onclick="judgeExpeseType(this.value)"/>管道
				  		</c:if>
				  	</td>
				  </tr>
				  <tr class=trcolor >
