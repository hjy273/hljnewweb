...
<html>
		...
		<script type="text/javascript">
			function checkForm(state){
				if(state=="1"){
					...
					$('tempFlag').value="1";
					processBar(editDrillSummary);
					editDrillSummary.submit();
					return;
				}
	...
	<body">
		<c:if test="${empty flag}">
			<template:titile value="修改演练总结"/>
		</c:if>
		<c:if test="${not empty flag}">
			<template:titile value="添加演练总结"/>
		</c:if>
		<html:form action="/drillSummaryAction.do?method=editDrillSummary" styleId="editDrillSummary" enctype="multipart/form-data">
			<input name="flag" value="${flag }" type="hidden" />
			<input type="hidden" value="<c:out value='${drillSummary.unapproveNumber }'/>" name="unapproveNumber"/>
			<input type="hidden" value="<c:out value='${drillSummary.id }'/>" name="id"/>
			...
			<table border="1" align="center" cellpadding="1" cellspacing="0" class="tabout" width="90%">
				...
				<tr class="trcolor">
					...
					<td class="tdulright">
						<input type="text" name="personNumber" id="personNumber" class="inputtext" style="width:200" value="${drillSummary.personNumber }" /> 人
						<font color="red">*</font>
					</td>
				</tr>
				<tr class="trcolor">
				...
				<tr class="trcolor">
					...
					<td class="tdulright">
						<input type="text" name="carNumber" id="carNumber" class="inputtext" style="width:200" value="${drillSummary.carNumber }" /> 辆
						<font color="red">*</font>
					</td>
				</tr>
				<tr class="trcolor">
				...
				<tr class="trcolor">
					...
					<td class="tdulright">
						<input type="text" name="equipmentNumber" id="equipmentNumber" class="inputtext" style="width:200" value="${drillSummary.equipmentNumber }" /> 套
						<font color="red">*</font>
					</td>
				</tr>
				<tr class="trcolor">
				...
				<tr class="trcolor">
					...
					<td class="tdulright">
						<textarea class="textarea" name="summary" id="summary" rows="3"><c:out value="${drillSummary.summary}" /></textarea>
						<font color="red">*</font>
					</td>
				</tr>
				<tr class="trcolor">
					...
					<td class="tdulright">
						<apptag:upload cssClass="" entityId="${drillSummary.id }" entityType="LP_DRILLSUMMARY" state="edit"/>
					</td>
				</tr>
				<tr class="trcolor">
					<apptag:approverselect label="审核人" inputName="approveId,mobiles"
							...
							approverType="approver" objectId="${drillSummary.id }" objectType="LP_DRILLSUMMARY" />
				</tr>
				<tr class="trcolor">
					<apptag:approverselect label="抄送人" inputName="reader,readerPhones"
							spanId="readerSpan" notAllowName="approveId" colSpan="2" 
							approverType="reader" objectId="${drillSummary.id }" objectType="LP_DRILLSUMMARY"/>
				</tr>
			</table>
			...
			<div align="center" style="height:40px">
				<input name="tempFlag" type="hidden" id="tempFlag" value="0"/>
