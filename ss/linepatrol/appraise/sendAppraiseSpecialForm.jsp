...
<html>
	...
	<body>
		<template:titile value="下发考核结果" />
			<html:form action="/appraiseSpecialAction?method=querySendAppraise" styleId="form">
			<template:formTable>
		...
		<html:form action="/appraiseSpecialAction.do?method=sendAppraise" onsubmit="return checked();">
