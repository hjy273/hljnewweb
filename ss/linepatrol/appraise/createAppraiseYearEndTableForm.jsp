...
<html>
	...
	<body>
		<template:titile value="生成年终检查汇总表" />
		<html:form action="/appraiseYearEndAction.do?method=createTable" styleId="form" onsubmit="return check();">
			<template:formTable>
				<template:formTr name="考核年份">
					<html:text property="appraiseTime" style="Wdate;width:140px;" styleId="appraiseTime" styleClass="inputtext required" onfocus="WdatePicker({dateFmt:'yyyy',maxDate:'${lastYear}'})"></html:text><font color="red">*</font>
				</template:formTr>
