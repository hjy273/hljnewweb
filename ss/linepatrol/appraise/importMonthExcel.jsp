...
<body onload="changeStyle()">
	<template:titile value="月考核表导入" />
	<template:formTable>
		<html:form action="/appraiseTableMonthAction.do?method=importExcel" styleId="form" enctype="multipart/form-data" onsubmit="return check();">
