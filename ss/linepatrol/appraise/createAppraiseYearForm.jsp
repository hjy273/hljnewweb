...
<html>
	...
	<script type="text/javascript">
		...
		if(document.getElementById("contractorId")&&document.getElementById("appraiseTime")){
	...
	<body>
		<template:titile value="年度考核生成" />
		<html:form action="/appraiseYearAction.do?method=createAppraiseYear" styleId="form" onsubmit="return check();">
			<template:formTable>
				<template:formTr name="考核年份">
					<html:text property="appraiseTime" style="Wdate;width:140px;" styleId="appraiseTime" styleClass="inputtext required" onfocus="WdatePicker({dateFmt:'yyyy'})" onchange="getContractNO();"></html:text><font color="red">*</font>
				</template:formTr>
