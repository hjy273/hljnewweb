...
<table border="1" align="center" width="100%" class="tabout">
	...
	<td class="tdulright" width="15%">业务模块</td>
	<td class="tdulright" width="10%">标底包</td>
	<td class="tdulright" width="40%">扣分说明</td>
	<td class="tdulright" width="10%">考核人</td>
	<td class="tdulright" width="15%">查看</td>
	...
	<c:forEach var="appraiseDailyMarks" items="${baseInfo['appraiseDailyMarks']}">
		<tr class="trcolor">
			...
			<td class="tdulright" ><a href="#" onclick="javascript:view('${appraiseDailyMarks['module']}','${appraiseDailyMarks['businessId']}');">查看记录</a></td>
			</c:if>
			<c:if test="${appraiseDailyMarks['module']=='other' }">
