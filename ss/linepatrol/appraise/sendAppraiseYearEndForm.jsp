...
<html>
	...
	<body>
		...
		<html:form action="/appraiseYearEndAction.do?method=querySendAppraise" styleId="form">
			<template:formTable>
		...
		<html:form action="/appraiseYearEndAction.do?method=sendAppraise" onsubmit="return checked();">
