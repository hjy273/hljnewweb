...
<html>
	<head>
		...
		<script type="text/javascript">
			function checkForm(){
				...
				var params = "";
  				var url = "${ctx}/questAction.do?method=judgeComExists&comName="+comName+"&comId="+comId;
	...
	<body>
		<template:titile value="修改参评对象"/>
		<html:form action="/questAction.do?method=editCom" styleId="editCom">
			<table align="center" cellpadding="1" cellspacing="0" class="tabout" width="90%">
				<tr class="trcolor">
					<input type="hidden" name="id" id="id" value="${comInfo.id }" /> 
					<td class="tdulleft" style="width:20%;">参评对象：</td>
					<td>
						<input type="text" name="comName" id="comName" value="${comInfo.object }">
					</td>
				</tr>
			</table>
