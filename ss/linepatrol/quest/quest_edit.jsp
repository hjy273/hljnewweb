		...
		<html:form action="/questAction.do?method=addQuest" styleId="addQuest">
			<table align="center" cellpadding="1" cellspacing="0" class="tabout" width="90%">
				<tr class="trcolor">
					...
					<input type="hidden" name="issueType" id="issueType" value="${issue.type }" />
					<td class="tdulleft" style="width:20%;">问卷名称：</td>
					<td class="tdulright">
						<input type="text" name="issueName" id="issueName" class="inputtext" style="width:150px;" value="${issue.name }" />
						<font color="red">*</font>
					</td>
				</tr>
				<tr class="trcolor">
				...
				<tr class="trcolor">
					...
					<td class="tdulright">
						...
						<input type="hidden" name="comIds" id="comIds" value="${companyId }">
				...
				<tr class="trcolor">
					...
					<td class="tdulright">
						<textarea class="textarea" rows="3" id="remark" name="remark"><c:out value="${issue.remark }"/></textarea>
						<font color="red">*</font>
					</td>
				</tr>
			</table>
