showDlg = function(inputName, spanId) {
	var actionURL = "/WebApp/load_processors.do?method=loadContractors&input_name="
...
showProcessorDlg = function(inputName, spanId, existName, inputType,
		displayType,exceptSelf,labelName) {
	var actionURL = "/WebApp/load_processors.do?method=loadProcessors&input_name="
			+ inputName
			+ "&span_id="
			+ spanId
			+ "&input_type="
			...
			+ "&label_name="
			+ labelName
			+ "&display_type=" + displayType + "&rnd=" + Math.random();
