...
<html>
	...
	<body>
		...
		<html:form action="/remedyTypeAction.do?method=addRemedyTypeByOneItem"
			...
			<template:formTable namewidth="150" contentwidth="300">
				...
				<template:formTr name="所属项目">
					<input name="itemID" value="<%=request.getAttribute("item_id")%>"
						type="hidden" />
					<input name="itemName"
						value="<%=request.getAttribute("item_name")%>" type="hidden" />
