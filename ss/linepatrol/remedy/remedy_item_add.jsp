...
<html>
	...
	<body>
		...
		<html:form action="/remedyItemAction.do?method=addRemedyItem"
			styleId="addRemedyItem">
			<template:formTable namewidth="150" contentwidth="300">
				<template:formTr name="项目名称">
					<html:text property="itemName" styleClass="inputtext"
						name="remedyItemBean" style="width:215;" maxlength="20"
						styleId="itemName" />
				</template:formTr>
				...
				<template:formTr name="备注">
					<html:textarea property="remark" name="remedyItemBean"
