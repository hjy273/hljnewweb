    ...
    <TR>
      <td>
        <table border="0" cellspacing="0" cellpadding="0">
          <tr align="center">
          	<td width=100 class="lbutton"  style="cursor:hand"><a href="${ctx}/accidentAction.do?method=loadAllTrouble&regionid=<%=regionid%>" target="iframemain"> 隐患查询列表</a></td>
            <td width=100 class="lbutton"  style="cursor:hand"><a href="${ctx}/accidentAction.do?method=loadUndoenTrouble&regionid=<%=regionid%>" target="iframemain"> 待处理隐患</a></td>
            <td width=100 class="lbutton"  style="cursor:hand"><a href="${ctx}/accidentAction.do?method=loadAllDoingTrouble&regionid=<%=regionid%>" target="iframemain"> 处理隐患</a></td>

            <td width=100 class="lbutton"  style="cursor:hand"> <a href="queryTrouble.jsp?regionid=<%=regionid%>" target="iframemain"> 隐患处理查询</a> </td>
