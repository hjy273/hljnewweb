...
function setCyc(objN){
    ...
    if(v == "1"){
        ...
        queryAcciBean.cyctype.value = "week";
    }
    ...
    if(v == "2"){
        ...
        queryAcciBean.cyctype.value = "month";
    }
...
function queryAccidentOpen(){
    ...
    formPop.focus();
    queryAcciBean.submit();
}

function queryAccident(){
    //queryAcciBean.contractorname.value = queryAcciBean.contractorid.options[queryAcciBean.contractorid.selectedIndex].text;
    queryAcciBean.submit();
}
...
function settype(objN){
    ...
    if(v == "1"){
        ...
        queryAcciBean.queryby.value = "contractor";
    }
    ...
    if(v == "2"){
        ...
        queryAcciBean.queryby.value = "subline";
    }
...
function setStaObj(){
    ...
    if(queryAcciBean.queryby.value == "subline"){

        queryAcciBean.staObj.value = queryAcciBean.contractorid.options[queryAcciBean.contractorid.selectedIndex].text;
...
<template:titile value="障碍处理情况查询"/>
<html:form method="Post" action="/accidentQueryAction.do?method=queryAccident">
