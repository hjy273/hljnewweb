...
<table id="closemenu" style="display:block; " width="6" height="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" style="display: "><img src="../images/arrow_close.gif" alt="隐藏菜单栏" name="Image1" width="6" height="58" id="Image1" style="cursor:hand" onClick="hidemenu();" onMouseOver="MM_swapImage('Image1','','../images/arrow_close_on.gif',1)" onMouseOut="MM_swapImgRestore()"></td>
  </tr>
</table>

<table id="openmenu" style="display:none; " width="6" height="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><img src="../images/arrow_resetf.gif" alt="显示菜单栏" name="Image2" width="6" height="58" id="Image2" onMouseOver="MM_swapImage('Image2','','../images/arrow_resetf_on.gif',1)" onMouseOut="MM_swapImgRestore()" style="cursor:hand" onClick="showmenu();"></td>
  </tr>
</table>
