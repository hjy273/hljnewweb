...
%>
<body>
<template:titile value="查询管道段信息"/>

<html:form method="Post" action="/PipeSegmentAction.do?method=queryPipeSegment&isReturn=false">
 ...
 <logic:notEmpty name="coninfo">
    ...
    <template:formTr name="管道段名称">
      <html:text property="pipename" styleClass="inputtext" style="width:160" maxlength="200"/>
    </template:formTr>
