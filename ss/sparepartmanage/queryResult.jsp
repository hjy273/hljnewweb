...
<html>
  ...
  <body>
      	...
      	<template:titile value="备件信息一览表"/>
      	 <display:table name="sessionScope.resList" id="currentRowObject" pagesize="18">
      	 	<%
      	 		deptType = (String)request.getAttribute("deptType");
      	 		object = (BasicDynaBean ) pageContext.findAttribute("currentRowObject");
      	 		if(object != null) {
	      	 		tid = (String) object.get("tid");
					state = (String) object.get("spare_part_state");
      		...
      		<display:column media="html" title="备件名称" sort="true">
      			<a href="javascript:toGetForm('<%=tid%>')"><%=spare_part_name %></a> 
      		</display:column>
            <display:column property="spare_part_model" title="备件型号" maxLength="10"  sort="true"/>
            <display:column property="software_version" title="软件版本"  maxLength="10" sort="true"/>
            <display:column property="product_factory" title="生产厂家"  maxLength="10" sort="true"/>
            <display:column media="html" title="操作" >
				   <%
	            	String depType = (String)request.getAttribute("deptType");
	            	if("1".equals(depType)) { %>
