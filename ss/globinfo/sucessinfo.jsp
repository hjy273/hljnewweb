...
<form action="2.htm">
    ...
    <tr>
      <td>
        <table border="0" cellspacing="10" cellpadding="0" align="center" bgcolor="8DAAD8" bordercolor="#000000">
          <tr>
            <td width="60" height="60" bgcolor="#FFFFFF" align="center"><img src="${ctx}/images/succ.gif" width="49" height="49"></td>
  ...
  <table border="0" cellspacing="10" cellpadding="0" align="center" >
             ...
             <%} else if(msg.getLink().equals("关闭")) {%>
             	<img  border="0" style="cursor:hand"   src="${ctx}/images/goback.gif" width="80" height="22" onClick="javascript:parent.close();" alt=""/>
             <%} else if(msg.getLink().indexOf("history.go")!=-1){%>
