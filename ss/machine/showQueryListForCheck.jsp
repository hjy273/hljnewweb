...
<html>
	<head>
		...
		<script type="text/javascript">
			getOneForm=function(id,type) {
				var flag = 1;
				var url="${ctx}/PollingTaskAction.do?method=showOneListForCheck&id="+id+"&type="+type+"&flag="+flag;
				window.location.href=url;
			}
			
			function exportList() {
				var url="${ctx}/MobileTaskAction.do?method=exportCheckedTaskInfo";
				window.location.href=url;
			}
		</script>
	</head>
	...
	<body>
		...
		<display:table name="sessionScope.queryList" requestURI="${ctx}/MobileTaskAction.do?method=doQueryForCheck" id="currentRowObject" pagesize="18">
			<%
	    ...
	    <html:link action="MobileTaskAction.do?method=exportCheckedTaskInfo">按照巡检类型导出为Excel</html:link>		
	</body>
</html>