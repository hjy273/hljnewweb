...
<body><br>
<template:titile value="更新月巡检计划"/>
<html:form action="/YearMonthPlanAction?method=updateYMPlan">
  <template:formTable>
    <template:formTr name="计划年月">
	<html:text property="year" name="YMplan" style="border:0;background-color:transparent;width:30px"></html:text>年<html:text property="month" name="YMplan" style="border:0;background-color:transparent;width:20px"></html:text>月
	</template:formTr>
    <template:formTr name="计划名称" isOdd="false">
        ...
        <html:hidden property="createuserid" name="YMplan"/>

      <html:text property="planname" name="YMplan" style="border:0;background-color:transparent;width:250px" />
    </template:formTr>
