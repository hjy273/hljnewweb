...
//取消添加
function Cancel(){
	location.href = "${ctx}/PlanAction.do?method=addWPlanShow";
}
...
<html:form action="/PlanAction?method=savePlan" >
	    ...
	    <input  id="deptname" type="hidden"  name="regionid" value="<bean:write name="LOGIN_USER_DEPT_NAME"/>"/>
  		<template:formTable namewidth="200" contentwidth="400">
		    ...
		    <template:formTr name="计划名称" isOdd="false">
			      <html:hidden property="planname" name="Plan" styleClass="inputtext"  style="border:0;background-color:transparent;width:300px" />
				  <bean:write name="Plan" property="planname" />
