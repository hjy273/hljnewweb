...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="24" align="center" class="title2">修改巡检点信息</td>
  </tr>
  <tr>
...
<html:form method="Post" action="/tpAction.do?method=updatePoint" focus="pointName">
 <html:hidden    property="pointID" value="<%=tpBean.getPointID()%>"/>
  ...
  <tr class="trcolor">
     ...
     <tr class="trcolor">
       <td class="tdulleft">所属巡检段</td>
       <td class="tdulright">
        <html:text    property="subLineID"   value="<%=tpBean.getSubLineID()%>"  size="20"      maxlength="45"/>
      </TD>
     </TR>
  <tr class="trwhite">
  ...
  <tr class="trcolor">
       ...
       <td class="tdulright">
        <html:text    property="regionID" value="<%=tpBean.getRegionID()%>"/>
      </TD>
     </TR>
    </TABLE>
<!--按钮表格开始-->
