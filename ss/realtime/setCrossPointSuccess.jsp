...
<table width="62%" border="0" align="center" cellpadding="3" cellspacing="0" class="tabout">
  <tr class="trcolor">
    <td class="tdulleft" width="22%">提示信息：</td>
    <td class="tdulright" width="78%"><%=msg%>    </td>
  </tr>
</table>
...
<SCRIPT LANGUAGE="JavaScript">
	setMapRefresh('RefreshCrossPoints')
</SCRIPT>
