...
if(role.equals("1")){
	...
	out.println(" 	var TREE_ITEMS = [  ['资源监控','资源监控',['资源监控','/ROUTEGIS/index.jsp?userID="+userinfo.getUserID()+"&regionID="+userinfo.getRegionID()+"']],                                                  ");
...
%>
<script language="javascript">
//alert(new tree(TREE_ITEMS, tree_tpl));
</script>
