...
<script language="javascript">
    ...
    function addGoBack()
    {
      var url = "${ctx}/checkaction.do?method=getChangeInfo";
      self.location.replace(url);
    }
</script>
<body>
<template:titile value="填写验收信息" />
<html:form action="/checkaction?method=addCheck" styleId="addCheckForm" onsubmit="return validate(this);" enctype="multipart/form-data">
...
<html:text property="checkdate" styleClass="Wdate" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd'})" style="width:250;" readonly="true" maxlength="26" />
</template:formTr>
<template:formTr name="验收负责人">
<input name="checkperson" value="<%=request.getAttribute("user_name")%>" type="text" 
  class="inputtext" style="width:250;" maxlength="10" />
</template:formTr>
...
<html:text property="square" value="0.0" styleClass="inputtext" style="width:250;" maxlength="8" />万元
</template:formTr>
