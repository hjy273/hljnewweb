...
<html:form action="/buildaction.do?method=updateBuild" styleId="addBuildForm" onsubmit="return validate(this);" enctype="multipart/form-data">
...
<html:text property="starttime" styleClass="inputtext" style="width:250;" readonly="true" maxlength="15" />
<apptag:date property="starttime" />
</template:formTr>
<template:formTr name="施工结束日期">
<html:text property="endtime" styleClass="inputtext" style="width:250;" readonly="true" maxlength="15" />
