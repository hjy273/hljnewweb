...
<html:text property="changelength" styleClass="inputtext" style="width:250;" value="0" maxlength="8" />米
</template:formTr>
...
<html:text property="plantime" styleClass="inputtext" style="width:250;" maxlength="5" />天
</template:formTr>
