...
function toAdd(idValue){
    var url = "${ctx}/changesurveyaction.do?method=loadAddForm&id=" + idValue;
    self.location.replace(url);
}
</script>
<template:titile value="填写勘查审定"/>
<body>

<display:table name="sessionScope.queryresult" requestURI="${ctx}/changeapplyaction.do?method=getApplyInfoList&op=survey" pagesize="18" id="currentRowObject">
<%
...
%>
  ...
  <apptag:checkpower thirdmould="50201" ishead="0">
  <%if (step.equals("A")||step.equals("B1")){   %>
