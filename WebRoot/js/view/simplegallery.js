...
var simpleGallery_navpanel={
	...
	images: [ '/bspweb/js/view/left.gif', '/bspweb/js/view/play.gif', '/bspweb/js/view/right.gif', '/bspweb/js/view/pause.gif'], //nav panel images (in that order)
