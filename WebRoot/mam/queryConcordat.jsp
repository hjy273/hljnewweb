  ...
  <template:formTable contentwidth="300" namewidth="200">
    ...
    <logic:equal value="1" name="LOGIN_USER" property="deptype">
      <template:formTr name="代维单位" >
        ...
        <html:select property="contractorID" styleClass="inputtext" style="width:200">
    ...
    <template:formTr name="设备型号" >
       <html:select property="terminalModel" styleId="select" onchange="viewStat(this);" styleClass="inputtext" style="width:200">
