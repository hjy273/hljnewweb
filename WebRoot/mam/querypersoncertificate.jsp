...
<html>
	<head>
		...
		<title>按条件查询人员证书信息</title>
	</head>
	<body>
		<template:titile value="条件查找人员证书信息" />
		<html:form action="/PersonCertificateAction?method=doQuery"
			styleId="queryForm2">
			<template:formTable namewidth="200" contentwidth="200">
				...
				<logic:equal value="1" name="LOGIN_USER" property="deptype">
					<template:formTr name="代维单位">
						...
						<input type="hidden" name="objecttype" value="CONTRACTORPERSON" />
					</template:formTr>
				</logic:equal>
