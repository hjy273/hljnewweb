...
<jsp:useBean id="patrolmanBean"
	class="com.cabletech.mam.beans.PatrolManBean" scope="request" />
	...
	tree = new Ext.tree.TreePanel({
		...
		root : new Ext.tree.AsyncTreeNode({
					...
					loader : new Ext.tree.TreeLoader({
								dataUrl : '${ctx}/ConPersonAction.do?method=getPerson&&persons_id=<bean:write name="patrolBean" property="patrolmanSon" />'
...
function isValidForm() {
	...
	return true;
		...
		judgeExistOtherPatrolman=function(personId){
			var flag=false;
			var queryString="patrolmanSon="+personId+"&patrolID=<bean:write name='patrolBean' property='patrolID' />&rnd="+Math.random();
    	...
    	judgeExist=function(){
			...
			var queryString="patrolName="+patrolName+"&parentID="+parentID+"&patrolID=<bean:write name='patrolBean' property='patrolID' />&rnd="+Math.random();
...
<html:form onsubmit="return isValidForm()" method="Post"
	action="/patrolAction.do?method=updatePatrol">
