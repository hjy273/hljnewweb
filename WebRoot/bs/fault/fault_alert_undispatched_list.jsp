...
<script type="text/javascript"
	src="${ctx }/bs/fault/js/fault_alert_undispatched_list.js"></script>
...
<template:titile value="未派单故障告警信息列表" />
<s:form action="faultAlertAction_unDispatchedList.jspx" method="post">
...
<display:table name="sessionScope.FAULT_ALERT_LIST" id="row"
	...
	<display:column media="html" title="操作" paramId="id">
		<a href="javascript:viewFaultAlert('${row.id}','${businessType}')">查看</a>
		<a href="javascript:dispatch('${row.id}','${businessType }')">派单</a>
		<a href="javascript:ignore('${row.id}','${businessType }')">忽略</a>
	</display:column>
</display:table>
