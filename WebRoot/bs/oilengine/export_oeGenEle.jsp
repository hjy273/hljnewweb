...
exports=function(){
	var exportDataItems=document.getElementById("exportForm").elements["exportOeGenEleDataItems"];
...
<body>
	...
	<s:form action="oeAttemperTaskAction_exportOeGenEle" name="exportForm" method="post">
			...
			<table width="98%" border="0" align="center" cellpadding="0"
				...
				<tr class="trcolor">
					<td class="tdulright" colspan="5">
						油机信息属性
						<input type="checkbox"
							onclick="allSelected(this,'exportOeGenEleDataItems');">
						全选/全不选
					</td>
				</tr>
				<c:forEach var="oneItem" items="${exportOeGenEleDataItemList}"
					varStatus="status">
					<c:if test="${status.index%5==0}">
						<tr class="trcolor">
					</c:if>
					<td class="tdulright" style="width: 20%">
						<input type="checkbox" name="exportOeGenEleDataItems"
							value="${oneItem.code }" />
						${oneItem.itemDesc }
					</td>
