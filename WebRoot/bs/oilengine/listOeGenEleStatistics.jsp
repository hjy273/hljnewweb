...
<body>
	<template:titile value="油机发电统计列表"/>
	<display:table name="session.OEGENELE" pagesize="18" export="fasle" id="row">
		...
		<display:column property="consumeQuantity" title="耗油量（升）"></display:column>
		<display:column property="eleDegree" title="发电量（度）"></display:column>
		<display:column property="eleTime" title="发电时间（分钟）"></display:column>
