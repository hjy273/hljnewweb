...
<html:form onsubmit="return isValidForm()" method="Post" action="/userinfoAction.do?method=queryUserinfo">
  <template:formTable contentwidth="300" namewidth="200">
    ...
    <template:formTr name="用&nbsp;户&nbsp;ID" >
      <html:text property="userID" styleClass="inputtext" style="width:200" maxlength="45"/>
    </template:formTr>
    <template:formTr name="姓&nbsp;&nbsp;&nbsp;&nbsp;名">
      <html:text property="userName" styleClass="inputtext" style="width:200" maxlength="45"/>
    </template:formTr>
    ...
    <template:formTr name="部门类别">
      ...
      代维单位
        ...
        <logic:notEmpty name="conlist">
          <template:formTr tagID="conlabel" style="display:none" name="代维单位" >
  ...
  <!-- 
    <template:formTr name="工&nbsp;&nbsp;&nbsp;&nbsp;号">
      <html:text property="workID" styleClass="inputtext" style="width:200" maxlength="45"/>
    </template:formTr>
