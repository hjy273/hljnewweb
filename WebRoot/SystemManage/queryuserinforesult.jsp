...
<display:table name="sessionScope.QUERYRESULT" id="currentRowObject" pagesize="18" >
  ...
  <display:column property="userid" title="用户ID"  maxLength="15"/>
  <display:column property="username"  title="用户名" maxLength="20"/>
  <display:column property="deptid"  title="部门/单位" maxLength="20"/>
  <display:column property="regionid"  title="所属区域" maxLength="5"/>
