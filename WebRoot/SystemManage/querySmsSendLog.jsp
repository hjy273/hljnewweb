...
<html:form method="Post" action="/smsLogAction.do?method=querySMS_SendLog" onsubmit=" return vertifyForm()">
  <template:formTable contentwidth="300" namewidth="200">
    ...
    <template:formTr name="开始日期">
      <html:text property="begindate" styleClass="Wdate inputtext"  style="width:180;"  readonly="true" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
    </template:formTr>
