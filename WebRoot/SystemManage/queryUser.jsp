...
<html:form   styleId="form1"   method="Post" action="/onlineuseraction.do?method=queryUserOnlineTime">
  ...
  <%}  %>
    ...
    <template:formTr name="开始日期">
      <input type="text" name="beginDate" class="inputtext" size="25" maxlength="45" readonly="readonly"/>
      <apptag:date property="beginDate"/>
    </template:formTr>
    <template:formTr name="结束日期">
      <input type="text" name="endDate" class="inputtext" size="25" maxlength="45" readonly="readonly"/>
