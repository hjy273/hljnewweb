...
<html:form method="Post"  styleId="addusergroup" onsubmit="return saveValue()" action="/UsergroupAction.do?method=addUsergroup">
  ...
  <template:formTable contentwidth="400" namewidth="250">
    ...
    <template:formTr name="用户组类型" >
      <html:select property="type"  styleId="typeId" styleClass="required" onchange="changeGroup()" style="width:160">
              <html:option value="1">移动用户组	</html:option>
              <html:option value="2">代维用户组	</html:option>
      </html:select>
    </template:formTr>
   <template:formTr name="用户组区域" >
