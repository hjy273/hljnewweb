...
<link rel="stylesheet" href="${ctx}/css/justforplanstat.css" type="text/css" media="screen, print" />
<br>
<table class="ooib" id="obody" border="0" cellspacing="0" cellpadding="0" width="100%" height="92%">
  <tr style="display:">
   <td>
  	  <div>
          <iframe id="UseTerminal" marginWidth="0" marginHeight="0" src="${ctx}/baseinfo/useTerminalChart.jsp" frameBorder=0 width="100%" scrolling=no height="100%"> </iframe>
      </div>
  </td>
  </tr>
  ...
  <td>
  	  <div>
          <iframe id="asc50" marginWidth="0" marginHeight="0" src="" frameBorder=0 width="100%" scrolling=no height="100%"> </iframe>
      </div>
  </td>
  </tr>
  <tr style="display:none">
   <td>
  	  <div>
          <iframe id="dsec50" marginWidth="0" marginHeight="0" src="" frameBorder=0 width="100%" scrolling=no height="100%"> </iframe>
      </div>
  </td>
  </tr>
