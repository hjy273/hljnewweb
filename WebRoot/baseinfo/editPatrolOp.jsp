...
<template:titile value="修改巡检事故码信息"/>
<html:form onsubmit="return isValidForm()" method="Post" action="/PatrolOpAction.do?method=updatePatrolOp">
  <template:formTable contentwidth="300" namewidth="200">
    <template:formTr name="事故类型" >
      ...
      <html:select property="optype" styleClass="inputtext" style="width:200" disabled="true">
    ...
    <template:formTr name="事故码">
      <html:text property="subcode" styleId="id"  onblur="valiD(id)" styleClass="inputtext" style="width:200" maxlength="2" disabled="true"/>
      &nbsp;
      ( 不含类别信息 )
</template:formTr>
    ...
    <template:formTr name="响应周期">
		<html:text property="noticecycle" styleClass="inputtext"  style="width:200" maxlength="45"/>
        &nbsp;(单位是小时)
    </template:formTr>
    <template:formTr name="处理周期" >
		<html:text property="handlecycle" styleClass="inputtext"  style="width:200" maxlength="45"/>
        &nbsp;(单位是小时)
    </template:formTr>
    ...
    <template:formTr name="备注" >
      <html:text property="remark" styleClass="inputtext" style="width:200" maxlength="145"/>
    </template:formTr>
    <template:formSubmit>
      <td>
