...
<html:form onsubmit="return isValidForm()" method="Post" action="/pointAction.do?method=updatePoint">
  <template:formTable contentwidth="300" namewidth="200">
    <template:formTr name="巡检点编号" >
      <html:text readonly="true" property="pointID" styleClass="inputtext" style="width:200" maxlength="45"/>
    </template:formTr>
    ...
    <template:formTr name="是否关键点" >
      <html:select property="isFocus" styleClass="inputtext" styleId="isFId" onchange="change()" style="width:200">
        <html:option value="0">否</html:option>
        <html:option value="1">是</html:option>
      </html:select>
    </template:formTr>
    <template:formTr name="所在线段顺序">
      <html:text property="inumber" styleClass="inputtext" style="width:200" maxlength="10" readonly="true"/>
    </template:formTr>
    ...
    <template:formTr name="状态">
	  <html:select property="state" styleClass="inputtext" styleId="sId" onchange="checked()" style="width:200">
