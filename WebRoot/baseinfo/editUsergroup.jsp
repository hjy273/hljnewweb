...
<html:form method="Post" styleId="form" action="/UsergroupAction.do?method=editUsergroup">
    ...
    <template:formTr name="用户组类型" >
        <select name="type" id="typeId" Class="inputtext"  style="width:160" onchange="changeGroup()">
        ...
        </select> <span style="color:red">* 我们不建议您在这里修改用户组类型</span>
    </template:formTr>

    <template:formTr name="所属区域"  tagID="regionidTr">
