...
<template:titile value="巡检事故码管理" />
<table height="90%" cellspacing="0" border="0" cellpadding="0">
<tr>
<td width="200" valign="top">
    &nbsp;&nbsp;&nbsp;&nbsp;<html:button property="button" styleClass="button"  onclick="sendTrouble()">下传事故码	</html:button><br>
    &nbsp;&nbsp;&nbsp;&nbsp;<html:button property="cancel"styleClass="button" onclick="ojavascript:showTypeMgr('new','','');">新建类型</html:button><br>
    &nbsp;&nbsp;&nbsp;&nbsp;<html:button property="cancel"styleClass="button" onclick="javascript:codeMgr('new','','');">新建故障码</html:button><br><hr><br>
