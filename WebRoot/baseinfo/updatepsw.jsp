...
<html:form  method="post" action="/userinfoAction.do?method=updatePsw">
    ...
    <template:formTable contentwidth="200" namewidth="200">
       ...
       <select name="userid" class="inputtext" style="width:170">
        <%
		...
		<template:formTr name="新&nbsp;密&nbsp;码">
			<input type="password" class="inputtext" style="width:170" name="p1" maxlength="16" >
		</template:formTr>
        <template:formTr name="确认密码">
			<input type="password" class="inputtext" style="width:170" name="p2" maxlength="16" >
		</template:formTr>
