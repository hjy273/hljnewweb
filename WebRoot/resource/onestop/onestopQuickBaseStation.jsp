...
Ext.onReady(function() {
	...
	patrolgroupcombotree.on('select', function(combo, record) {
			if("PATROLMAN"!=record.attributes.objtype){
				...
				//document.forms[0].elements["patrolGroupId"].value=record.attributes.id;
...
<body>
	<template:titile value="基站信息" />
	<s:form action="oneStopQuick_saveStation" name="edit" method="post" id="addBasestationForm">
				...
				<tr class="trwhite">
					...
					<td class="tdulright" style="width: 35%">
						<input type="text" name="baseStation.city"
							value="${LOGIN_USER_REGION_NAME}" value="${baseStation.city}"
							readonly="readonly" class="inputtext required"
				...
				<tr class="trwhite">
					...
					<td class="tdulright" style="width: 35%">
						<input type="text" name="baseStation.anTime"
							value="<bean:write name="baseStation" property="anTime" format="yyyy-MM-dd" />"
							readonly="readonly" class="Wdate inputtext required"
							style="width: 220px"
		...
		<table width="40%" border="0" style="margin-top: 6px" align="center"
			...
			<tr align="center">
				<td>
					<input type="submit" id="isubmit" class="button" value="保存">
				</td>
			</tr>
		</table>
