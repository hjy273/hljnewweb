...
<body>
	<template:titile value="选择要导出的天线属性"/>
	<s:form action="antennaAction_export" name="exportForm" method="post">
		<input type="hidden" name="antennaName" value="${antenna.antennaName}"/> 
		<input type="hidden" name="antennaCode" value="${antenna.antennaCode}"/> 
		<input type="hidden" name="parentId" value="${antenna.parentId}"/> 
