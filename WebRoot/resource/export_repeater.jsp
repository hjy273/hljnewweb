...
<body>
	<template:titile value="选择要导出的直放站属性"/>
	<s:form action="repeaterAction_export" name="exportForm" method="post">
		<input type="hidden" name="city" value="${repeater.city}"/> 
		<input type="hidden" name="repeaterType" value="${repeater.repeaterType}"/> 
		<input type="hidden" name="msBsId" value="${repeater.msBsId}"/> 
		<input type="hidden" name="installPlace" value="${repeater.installPlace}"/> 
