...
<body>
	<template:titile value="选择要导出的小区属性"/>
	<s:form action="cellAction_export" name="exportForm" method="post">
		<input type="hidden" name="cellCode" value="${cell.cellCode}"/> 
		<input type="hidden" name="chineseName" value="${cell.chineseName}"/> 
		<input type="hidden" name="parentId" value="${cell.parentId}"/> 
