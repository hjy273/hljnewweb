...
<body>
	<template:titile value="选择要导出的设备属性"/>
	<s:form action="equipmentAction_export" name="exportForm" method="post">
		<input type="hidden" name="equName" value="${equipment.equName}"/> 
		<input type="hidden" name="equTypeId" value="${equipment.equTypeId}"/> 
		<input type="hidden" name="equModel" value="${equipment.equModel}"/> 
		<input type="hidden" name="equProducter" value="${equipment.equProducter}"/>
		<input type="hidden" name="stationCode" value="${equipment.stationCode}"/>  
