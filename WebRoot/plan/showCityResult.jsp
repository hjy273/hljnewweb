	...
	<body>		
		...
		<div id="fieldSet4EL">
			<display:table name="sessionScope.patrolregioninfo"
				id="currentRowObject">
				<display:column title="县区" property="regionname" />
				<display:column title="代维公司" property="contractorname" />
				<display:column title="区县的站点数" property="rescount" />
				<display:column title="计划巡检站点数" property="planrescount" />
				<display:column title="实际巡检站点数" property="alreadypatrolcount" />
				<display:column title="巡检率" property="patrolrate" />
			</display:table>
		</div>
	</body>
